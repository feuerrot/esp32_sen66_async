...
class max7219:
	...
	def __init__(self):
		...
		self.spi.init(sck=machine.Pin(18), mosi=machine.Pin(23), baudrate=10000)
		self.set_shutdown()
		self.set_decode()
		self.set_intensity()
		self.set_limit()
	...
	def write_string(self, string):
		if not string:
			raise Exception("not a string: {}".format(string))
		if len(string) > 8:
			raise Exception("string too long: {}".format(string))
